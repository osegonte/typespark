...
install_dependencies() {
    ...
    # Install psutil for diagnostics
    pip install psutil
    
    # Try to install PyMuPDF with improved compatibility
    echo "Attempting to install PyMuPDF..."
    pip install --upgrade "PyMuPDF>=1.24.0" || echo "PyMuPDF installation failed, will fall back to PyPDF2"
...
echo "  1. ./run.sh (to start both backend and frontend)"
